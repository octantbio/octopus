...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description=
        'Create symlinks to all fastq\'s in a sequencing directory. Just specify where the sequencing run is located relative to the current directory and we\'ll handle the rest!'
    )
    ...
    if path_to_reference.exists():
        ...
        print('NO INPUT REFERENCE!\nWill run through de novo assembly only.',
              file=sys.stdout)
